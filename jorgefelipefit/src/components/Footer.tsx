...
const LINKS = [
  {
    title: "Produtos",
    items: ["Planos", "Mulher Maravilha", "Consultoria", "Vídeos de treinamento"],
  },
  {
    title: "Recursos",
    items: ["Posts", "Contatos", "Eventos", "Ajuda"],
  },
];
        ...
        <footer className="relative w-full mt-12">
            <div className="mx-auto w-full max-w-7xl px-8">
                <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
                    ...
                    >
                        &copy; {currentYear} <a href="https://material-tailwind.com/">Jorge Felipe Fit</a>. Todos os direitos reservados.
                    </Typography>
